sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("whr/com/br/app", ".html");
		...
		return Opa5.extend("whr.com.br.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["whr/com/br/localService/mockserver"], function (mockserver) {
